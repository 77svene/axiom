...
from axiom.core._types import Optional, ProxyType, Unpack
from axiom.engines.toolbelt.proxy_rotation import is_proxy_error
from axiom.engines.toolbelt.convertor import Response, ResponseFactory
from axiom.engines._browsers._types import PlaywrightSession, PlaywrightFetchParams
from axiom.engines._browsers._base import SyncSession, AsyncSession, DynamicSessionMixin
from axiom.engines._browsers._validators import validate_fetch as _validate, PlaywrightConfig
...
class DynamicSession(SyncSession, DynamicSessionMixin):
    ...
    def __init__(self, **kwargs: Unpack[PlaywrightSession]):
        ...
        :param google_search: Enabled by default, axiom will set a Google referer header.
        ...
        :param additional_args: Additional arguments to be passed to Playwright's context as additional settings, and it takes higher priority than axiom's settings.
        """
