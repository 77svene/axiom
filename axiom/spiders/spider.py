...
from axiom.spiders.request import Request
from axiom.spiders.engine import CrawlerEngine
from axiom.spiders.session import SessionManager
from axiom.core.utils import set_logger, reset_logger
from axiom.spiders.result import CrawlResult, CrawlStats
from axiom.core._types import Set, Any, Dict, Optional, Union, TYPE_CHECKING, AsyncGenerator
...
class Spider(ABC):
    ...
    def __init__(self, crawldir: Optional[Union[str, Path, AsyncPath]] = None, interval: float = 300.0):
        ...
        self.logger = logging.getLogger(f"axiom.spiders.{self.name}")
        self.logger.setLevel(self.logging_level)
        self.logger.handlers.clear()
        self.logger.propagate = False  # Don't propagate to parent 'axiom' logger
    ...
    def configure_sessions(self, manager: SessionManager) -> None:
        ...
        """
        from axiom.fetchers import FetcherSession
